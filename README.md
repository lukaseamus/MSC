...
`loss.csv` contains data that are relevant to the combinatorial meta-analysis regarding the effect of seagrass loss on ecosystem functions. It is necessary to plot Figure 2 (see `Methods.pdf` for details).
